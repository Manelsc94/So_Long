...
/*   Updated: 2024/09/26 15:28:32 by mde-agui         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	free_sprites(t_game *game)
{
	...
	{
		if (game->pl_s[i] != NULL)
			mlx_destroy_image(game->mlx, game->pl_s[i]);
		if (game->fo_t[i] != NULL)
			mlx_destroy_image(game->mlx, game->fo_t[i]);
		if (game->pa_t[i] != NULL)
			mlx_destroy_image(game->mlx, game->pa_t[i]);
		i++;
	}
	if (game->wall_t != NULL)
